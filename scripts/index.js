...
function createItems() {
  new Item(
    ...
    function (buy) {
      ...
      l("crew-members").innerHTML +=
        `<img class="crew" src="${AssetPaths[2]}${randomImage(crewSkillImages)}"></img>`;
    },
  );
  ...
  new Item(
    ...
    function (buy) {
      ...
      l("equipment").innerHTML +=
        `<img class="equipment" src="${AssetPaths[1]}${randomImage(equipmentImages)}"></img>`;
    },
  );
}
